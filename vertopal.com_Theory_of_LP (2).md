...
That is, the cost coefficients, $\mathbf c = (c_1, c_2)$, have values 40
...
How do we choose the best coefficients $v_1$, and $v_2$? We must ensure
...
Unless the objective is constant, every optimal point to an LP will
